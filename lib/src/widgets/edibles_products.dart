...
class EdiblesProducts extends StatelessWidget {
  final List<EdiblesSingle_Prod> _product_list = ediblesProductlist;
  @override
    ...
    return Stack(children: [
      ...
      Scaffold(
        ...
        body: GridView.builder(
            itemCount: ediblesProductlist.length,
            gridDelegate: new SliverGridDelegateWithFixedCrossAxisCount(
                crossAxisCount: 2),
            itemBuilder: (BuildContext context, int index) {
              return EdiblesSingle_Prod(
