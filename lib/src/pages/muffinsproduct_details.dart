...
class MuffinsProductDetails extends StatefulWidget {
  final product_detail_name;
  var product_detail_price;
  final product_detail_picture;
  final product_detail_description;
  final product_detail_200mg;
  final product_detail_250mg;
  final product_detail_300mg;

  MuffinsProductDetails(
      {this.product_detail_name,
      this.product_detail_price,
      this.product_detail_picture,
      this.product_detail_description,
      this.product_detail_200mg,
      this.product_detail_250mg,
      this.product_detail_300mg});

  @override
  _MuffinsProductDetailsState createState() =>
      _MuffinsProductDetailsState();
}

class _MuffinsProductDetailsState extends State<MuffinsProductDetails> {
  OrderPage _orderPage = new OrderPage();
  String _selectedGram = "200mg";
