...
class ExoticGHProductDetails extends StatefulWidget {
  final product_detail_name;
  var product_detail_price;
  final product_detail_picture;
  final product_detail_description;

  ExoticGHProductDetails(
  ...
  @override
  _ExoticGHProductDetailsState createState() => _ExoticGHProductDetailsState();
}

class _ExoticGHProductDetailsState extends State<ExoticGHProductDetails> {
