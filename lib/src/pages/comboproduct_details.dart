...
class ComboProductDetails extends StatefulWidget {
  ...
  @override
  _ComboProductDetailsState createState() => _ComboProductDetailsState();
}

class _ComboProductDetailsState extends State<ComboProductDetails> {
