...
class GreenHouseProductDetails extends StatefulWidget {
  final product_detail_name;
  var product_detail_price;
  final product_detail_picture;
  final product_detail_description;

  GreenHouseProductDetails(
  ...
  @override
  _GreenHouseProductDetailsState createState() =>
      _GreenHouseProductDetailsState();
}

class _GreenHouseProductDetailsState extends State<GreenHouseProductDetails> {
  OrderPage _orderPage = new OrderPage();
  String _selectedGram = "4g";
                            ...
                            content: new DropdownButton<String>(
                              ...
                              onChanged: (String val) {
                                ...
                                setState(() {
                                  ...
                                  } else if (_selectedGram == "6g") {
                                    widget.product_detail_price = 150;
                                  } else if (_selectedGram == "8g") {
                                    widget.product_detail_price = 200;
                                  } else if (_selectedGram == "12g") {
