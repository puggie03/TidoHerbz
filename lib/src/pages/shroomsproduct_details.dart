...
class ShroomsProductDetails extends StatefulWidget {
  final product_detail_name;
  var product_detail_price;
  final product_detail_picture;
  final product_detail_description;
  final product_detail_1g_type1;
  final product_detail_1g_type2;
  final product_detail_2g_type1;
  final product_detail_2g_type2;
  final product_detail_2g_type3;
  final product_detail_2g_type4;
  final product_detail_type1;
  final product_detail_type2;
  final product_detail_type3;
  final product_detail_type4;

  ShroomsProductDetails(
      {this.product_detail_name,
      this.product_detail_price,
      this.product_detail_picture,
      this.product_detail_description,
      this.product_detail_1g_type1,
      this.product_detail_1g_type2,
      this.product_detail_2g_type1,
      this.product_detail_2g_type2,
      this.product_detail_2g_type3,
      this.product_detail_2g_type4,
      this.product_detail_type1,
      this.product_detail_type2,
      this.product_detail_type3,
      this.product_detail_type4});

  @override
  _ShroomsProductDetailsState createState() => _ShroomsProductDetailsState();
}

class _ShroomsProductDetailsState extends State<ShroomsProductDetails> {
  OrderPage _orderPage = new OrderPage();
  String _selectedGram = "1g";
  String _selectedType = "Golden Teachers";
                            ...
                            content: new DropdownButton<String>(
                              ...
                              onChanged: (String val) {
                                ...
                                setState(() {
                                  ...
                                  } else if (_selectedGram == "1g" &&
                                      _selectedType == "Golden Teachers") {
                                    widget.product_detail_price = 120;
                                  } else if (_selectedGram == "2g" &&
                                      _selectedType == "Golden Teachers") {
                                    widget.product_detail_price = 200;
                                  } else if (_selectedGram == "2g" &&
                                      _selectedType == "African Transkei") {
                                    widget.product_detail_price = 250;
                                  } else if (_selectedGram == "1g" &&
                                      _selectedType == "African Transkei") {
                                    _selectedGram = "2g";
                                    widget.product_detail_price = 250;
                                  } else if (_selectedGram == "1g" &&
                                      _selectedType == "Rusky Whites") {
                                    _selectedGram = "2g";
                                    widget.product_detail_price = 250;
                                  } else if (_selectedGram == "2g" &&
                                      _selectedType == "Rusky Whites") {
                              ...
                              builder: (context) => OrderPage(
                                    ...
                                    cartpage_prod_amount:
                                        _orderPage.calculateTotal(
                                            widget.product_detail_price),
                                    cartpage_prod_gram: "1g",
                                    cartpage_prod_strain: "Penis Envy",
                                    //cart: prod_description,
                                  )),
                        );
                      } else if (_selectedGram == "2g" &&
                              ...
                              builder: (context) => OrderPage(
                                    ...
                                    cartpage_prod_amount:
                                        _orderPage.calculateTotal(
                                            widget.product_detail_price),
                                    cartpage_prod_gram: "1g",
                                    cartpage_prod_strain: "Golden Teachers",
                                    //cart: prod_description,
                                  )),
                        );
                      } else if (_selectedGram == "2g" &&
                              ...
                              builder: (context) => OrderPage(
                                    ...
                                    cartpage_prod_amount:
                                        _orderPage.calculateTotal(
                                            widget.product_detail_price),
                                    cartpage_prod_gram: "2g",
                                    cartpage_prod_strain: "African Transkei",
                                    //cart: prod_description,
                                  )),
                        );
                      } else if (_selectedGram == "2g" &&
                              ...
                              builder: (context) => OrderPage(
                                    ...
                                    cartpage_prod_amount:
                                        _orderPage.calculateTotal(
                                            widget.product_detail_price),
                                    cartpage_prod_gram: "2g",
                                    cartpage_prod_strain: "Rusky Whites",
                                    //cart: prod_description,
                                  )),
                        );
                      }
