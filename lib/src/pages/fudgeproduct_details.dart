...
class FudgeProductDetails extends StatefulWidget {
  ...
  FudgeProductDetails(
      ...
      this.product_detail_350mg});

  @override
  _FudgeProductDetailsState createState() =>
      _FudgeProductDetailsState();
}

class _FudgeProductDetailsState extends State<FudgeProductDetails> {
                            ...
                            content: new DropdownButton<String>(
                              ...
                              onChanged: (String val) {
                                ...
                                setState(() {
                                  ...
                                  } else if (_selectedGram == "350mg") {
                                    widget.product_detail_price = 90;
                                  }
                                });
