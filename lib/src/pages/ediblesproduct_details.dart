...
class EdiblesProductDetails extends StatefulWidget {
  final product_detail_name;
  final product_detail_price;
  final product_detail_picture;
  final product_detail_description;
  final product_detail_100mg;
  final product_detail_200mg;
  final product_detail_300mg;
  final product_detail_500mg;
  ...
  EdiblesProductDetails(
      {this.product_detail_name,
      this.product_detail_price,
      this.product_detail_picture,
      this.product_detail_description,
      this.product_detail_100mg,
      this.product_detail_200mg,
      this.product_detail_300mg,
      this.product_detail_500mg,
  ...
  @override
  _EdiblesProductDetailsState createState() => _EdiblesProductDetailsState();
}

class _EdiblesProductDetailsState extends State<EdiblesProductDetails> {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                            ...
                            builder: (context) => OrderPage(
                                ...
                                cartpage_prod_amount: _orderPage
                                    .calculateTotal(widget.product_detail_price)
                                //cart: prod_description,
                                )),
                      );
                      showDialog(
