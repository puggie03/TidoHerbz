...
class LollipopsProductDetails extends StatefulWidget {
  ...
  @override
  _LollipopsProductDetailsState createState() =>
      _LollipopsProductDetailsState();
}

class _LollipopsProductDetailsState extends State<LollipopsProductDetails> {
  OrderPage _orderPage = new OrderPage();
  String _selectedGram = "100mg";
                    ...
                    showDialog(
                        ...
                        builder: (context) {
                          return new AlertDialog(
                            title: new Text("Milligrams"),
                            content: new DropdownButton<String>(
                              hint: Text("Choose the milligram"),
                              value: _selectedGram,
                              items: <String>[
                                '100mg',
                                '200mg',
                              ...
                              onChanged: (String val) {
                                ...
                                setState(() {
                                  _selectedGram = val;
                                  if (_selectedGram == "100mg") {
                                    widget.product_detail_price = 50;
                                  } else if (_selectedGram == "200mg") {
                                    widget.product_detail_price = 60;
                                  } else if (_selectedGram == "300mg") {
                                    widget.product_detail_price = 70;
                                  } else if (_selectedGram == "500mg") {
                                    widget.product_detail_price = 100;
                                  }
                                });
