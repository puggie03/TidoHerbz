...
class BongsKProductDetails extends StatefulWidget {
  final product_detail_name;
  final product_detail_price;
  final product_detail_picture;
  final product_detail_description;

  BongsKProductDetails(
  ...
  @override
  _BongsKProductDetailsState createState() => _BongsKProductDetailsState();
}

class _BongsKProductDetailsState extends State<BongsKProductDetails> {
